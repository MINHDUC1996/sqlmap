# sqlmap with Simple MENU

# NEW STUFF
This is the fork version of sqlmap with a new file: RUN.sh
RUN.sh will help you run sqlmap with simple MENU and some pre-setting, which can save your time and better result.
